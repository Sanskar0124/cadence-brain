...
/**
  ...
  @param {string } inviting_user_first_name first name of the user who is sending the invite mail 
...
<div>
    ...
    language === USER_LANGUAGES.SPANISH ? ',' : ''
																										...
																										<div style="color: rgb(60, 72, 88)">
																											<span style="color: rgb(0, 0, 0)"
																												>${inviting_user_first_name} ${
    TRANSLATIONS?.HAS_INVITED_YOU?.[language] || ''
  }.</span
																											>
																										</div>
																										<div style="color: rgb(60, 72, 88)">
