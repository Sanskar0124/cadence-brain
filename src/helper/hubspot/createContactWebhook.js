...
const createContactWebhook = async (lead, company_id, t) => {
  try {
    logger.info('Creating contact..');

    let account, errForAccount;
    if (!lead.account?.account_id || lead.account?.account_id == null) {
...
module.exports = createContactWebhook;
