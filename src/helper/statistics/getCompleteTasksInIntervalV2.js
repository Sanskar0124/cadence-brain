...
// Helper
const formatTasksToIntervalsV2 = require('./formatTasksToIntervalsV2');

const getCompleteTasksInIntervalV2 = async (
  clientQueryParams,
  dbQueryParams,
  heatMap
) => {
  try {
    ...
    let heatMapUpdated = formatTasksToIntervalsV2(
      tasks,
      user?.timezone,
      heatMap
    );
...
module.exports = getCompleteTasksInIntervalV2;
