...
const createExistingLeadFromSalesforce = async ({
  lead,
  cadence,
  node,
  company_id,
  ...
  try {
    ...
    [null, { error: err.message, integration_id: lead.integration_id }];
  }
};

module.exports = createExistingLeadFromSalesforce;
