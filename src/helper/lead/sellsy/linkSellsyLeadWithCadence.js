...
const { CADENCE_STATUS, IMPORT_ERROR_TYPE } = require('../../../utils/enums');
...
const linkSellsyLeadWithCadence = async ({
  lead_id,
  integration_id,
  company_id,
  lead_cadence_order,
  ...
  try {
    ...
    return [null, { error: err.message, integration_id, sr_no }];
  }
};

module.exports = linkSellsyLeadWithCadence;
