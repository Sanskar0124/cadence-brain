...
const createContactFromSalesforce = async (
  { lead, company_id, access_token, instance_url },
  t
) => {
  try {
    ...
    let [createdLead, errForLead] = await Repository.create({
      ...
      createObject: {
        ...
        salesforce_contact_id: lead.integration_id ?? null,
...
module.exports = createContactFromSalesforce;
