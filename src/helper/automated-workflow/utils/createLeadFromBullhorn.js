...
const createLeadFromBullhorn = async ({ lead, company_id }, t) => {
  try {
    logger.info('Creating lead from Bullhorn...');
    let account = null,
      errForAccount;
    ...
    logger.error(`An error occurred while creating lead from Bullhorn: `, err);
