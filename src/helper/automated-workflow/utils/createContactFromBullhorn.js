...
const createContactFromBullhorn = async ({ lead, company_id }, t) => {
  try {
    logger.info('Creating contact from Bullhorn...');
    let account = null,
      errForAccount;
    ...
    logger.error(
      `An error occurred while creating contact from Bullhorn: `,
      err
    );
...
module.exports = createContactFromBullhorn;
