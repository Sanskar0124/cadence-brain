const { ADVANCED_WORKFLOW_GRPC_URL } = require('../../../utils/config');
...
const PROTO_FILE = 'advance_workflow.proto';

const pkgDefs = protoLoader.loadSync(PROTO_FILE, options);

const proto = grpc.loadPackageDefinition(pkgDefs);

const client = new proto.AdvanceWorkflowService(
  ADVANCED_WORKFLOW_GRPC_URL,
