// Utils
const { CALENDAR_GRPC_URL } = require('../../../utils/config');
...
const PROTO_FILE = 'calendar.proto';

const pkgDefs = protoLoader.loadSync(PROTO_FILE, options);

const proto = grpc.loadPackageDefinition(pkgDefs).calendar;

const client = new proto.CalendarService(
  CALENDAR_GRPC_URL,
